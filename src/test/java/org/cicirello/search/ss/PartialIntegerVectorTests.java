...
public class PartialIntegerVectorTests {
  ...
  public void testConstructor1() {
    ...
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new PartialIntegerVector(-1, 2, 2));
    thrown = assertThrows(IllegalArgumentException.class, () -> new PartialIntegerVector(1, 3, 2));
  }
  ...
  public void testConstructor2true() {
    ...
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new PartialIntegerVector(-1, 2, 2, true));
    thrown =
        assertThrows(IllegalArgumentException.class, () -> new PartialIntegerVector(1, 3, 2, true));
  }
  ...
  public void testConstructor2false() {
    ...
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new PartialIntegerVector(-1, 2, 2, false));
    thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new PartialIntegerVector(1, 3, 2, false));
  }
      ...
      for (int width = 1; width <= 3; width++) {
        ...
        for (int i = 0; i < n; i++) {
          ...
          ArrayIndexOutOfBoundsException thrown =
              assertThrows(
                  ArrayIndexOutOfBoundsException.class, () -> v.getExtension(v.numExtensions()));
          thrown =
              assertThrows(ArrayIndexOutOfBoundsException.class, () -> v.extend(v.numExtensions()));
          v.extend(i % width);
          ...
          thrown = assertThrows(ArrayIndexOutOfBoundsException.class, () -> v.get(v.size()));
        }
