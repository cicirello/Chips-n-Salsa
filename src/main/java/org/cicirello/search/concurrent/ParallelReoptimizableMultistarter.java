 ...
 *
 * <p>When calling the {@link #optimize optimize} or {@link #reoptimize reoptimize} methods, the
 * runLength parameter corresponds to the number of restarts for each of the multistarter instances,
 * where those restarts will have run lengths determined by the restart schedule specified upon
 * construction. If the {@link #optimize optimize} or {@link #reoptimize reoptimize} are called
 * multiple times, the restart schedules of the parallel metaheuristics are not reinitialized, and
 * the run lengths for the additional restarts will continue where the schedules left off.
 *
