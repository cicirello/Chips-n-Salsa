...
/**
 * <p>This class implements a parameter-free version of the linear
 * cooling schedule for simulated annealing.
 * In this parameter-free version of the linear cooling schedule, the
 * initial temperature, the value of &Delta;t, and the step size are all computed
 * by the ParameterFreeLinearCooling object based on an estimate of the
 * cost difference between random neighbors, and the run length specified
 * upon calling the {@link #init} method.</p>
 *
 * <p>In linear cooling, the k-th temperature, t<sub>k</sub>, is
 ...
 *
 * <p>We then set &Delta;t and steps (number of transitions between temperature changes) based on the
 ...
 * we set &Delta;t = (t<sub>0</sub> - 0.001) / ceiling(k / steps), 
 ...
 * to the lowest power of 2 such that the &Delta;t we compute is &Delta;t &ge; 10<sup>-6</sup>.  The rationale
...
public final class ParameterFreeLinearCooling implements AnnealingSchedule {
	...
	/**
	 * Constructs a linear cooling schedule that 
	 ...
	 * temperature, temperature delta, and step size.
	 */
