...
/**
 * <p>This class implements an insertion mutation on permutations, where one mutation
 * consists in removing a randomly chosen element and reinserting it
 * at a different randomly chosen location.  The removed element is chosen uniformly at random
 * from among all possible elements, and the new location is chosen uniformly at random
 * from among all possible new locations.</p>
 ...
 * where n is the length of the permutation.  The worst case runtime occurs when the removed element
