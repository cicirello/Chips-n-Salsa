 ...
 *
 * <p>This class transforms the cost of solution s to fitness to meet these requirements with the
 ...
 *
 * <p>Note that the problem's implementation of minCost must return a finite lower bound for the
