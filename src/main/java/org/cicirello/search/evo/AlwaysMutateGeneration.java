...
/**
 * An AlwaysMutateGeneration is the common cycle of: select, apply crossover to pairs of parents
 * based on C, apply mutation to each population member with rate M, replace. However, it is the
 * special case when M=1.0, such that every member of the population is mutated once in each
 * generation.
 *
