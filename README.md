...
| __JaCoCo Test Coverage__ | [![coverage](https://img.shields.io/endpoint?url=https://www.cicirello.org/endpoints/chips-n-salsa/jacoco.json)](https://github.com/cicirello/Chips-n-Salsa/actions/workflows/build.yml) [![branches coverage](https://img.shields.io/endpoint?url=https://www.cicirello.org/endpoints/chips-n-salsa/branches.json)](https://github.com/cicirello/Chips-n-Salsa/actions/workflows/build.yml) |
