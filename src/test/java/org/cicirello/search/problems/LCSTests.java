...
public class LCSTests {
	...
	public void testExceptions() {
		IllegalArgumentException thrown = assertThrows( 
			...
			() -> new LargestCommonSubgraph(0, 0.5, true)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, -1E-10, true)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, 1+1E-10, true)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(0, 0.5, false)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, -1E-10, false)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, 1+1E-10, false)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(0, 0.5, true, 42)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, -1E-10, true, 42)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
		...
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(0, 0.5, false, 42)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, -1E-10, false, 42)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
		...
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(0, 5, 0.5, 0.5)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, 0, 0.5, 0.5)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, 6, -1E-10, 0.5)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, 6, 0.5, -1E-10)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, 6, 1+1E-10, 0.5)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, 6, 0.5, 1+1E-10)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(6, 5, -1E-10, 0.5)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(6, 5, 0.5, -1E-10)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(6, 5, 1+1E-10, 0.5)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(6, 5, 0.5, 1+1E-10)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(0, 5, 0.5, 0.5, 42)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, 0, 0.5, 0.5, 42)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, 5, -1E-10, 0.5, 42)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new LargestCommonSubgraph(5, 5, 0.5, -1E-10, 42)
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
