 ...
 * randomly swapping a pair of adjacent elements. The random choice of elements is performed
 * uniformly at random from among all adjacent pairs. If the length of the permutation is n, there
 * are n-1 such adjacent pairs. The runtime of both the {@link #mutate(Permutation) mutate} and
 * {@link #undo(Permutation) undo} methods is O(1).
 *
...
public final class AdjacentSwapMutation
   ...
   * {@inheritDoc}
   *
   * <p>The worst case runtime of the {@link MutationIterator#hasNext}, {@link
   * MutationIterator#nextMutant}, {@link MutationIterator#setSavepoint}, and {@link
