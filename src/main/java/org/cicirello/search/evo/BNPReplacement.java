 ...
 * Initially, the distance threshold is computed based on the mean distance between all candidate solutions.
 ...
 * problems:
 *
 * <p>Cornejo-Acosta, J. A., Segura, C., Garcia-Diaz, J., & Perez-Sansalvador, J. C. (2026).
 ...
 *
 * <p>Segura, C., Lugo, L., Miranda, G., & Serrano Cardenas, E. D. (2024). PACE Solver Description:
 * CIMAT_Team. In E. Bonnet & P. Rzazewski (Eds.), 19th International Symposium on Parameterized and
 * Exact Computation (IPEC 2024) (Vol. 321, p. 31:1-31:4). Schloss Dagstuhl – Leibniz-Zentrum fur
 * Informatik. https://doi.org/10.4230/LIPIcs.IPEC.2024.31
 *
 * <p>Lugo, L., Segura, C., & Miranda, G. (2022). A diversity-aware memetic algorithm for the linear
 * ordering Problem. Memetic Computing, 14(4), 395-409. https://doi.org/10.1007/s12293-022-00378-5
 *
 * <p>Hernandez Constantino, O., & Segura, C. (2022). A parallel memetic algorithm with explicit
 ...
 *
 * <p>Chacón Castillo, J., & Segura, C. (2020). Differential evolution with enhanced diversity
 * maintenance. Optimization Letters, 14(6), 1471–1490. https://doi.org/10.1007/s11590-019-01454-5
 *
 * <p>Romero Ruiz, E., & Segura, C. (2018). Memetic Algorithm with Hungarian Matching Based
 * Crossover and Diversity Preservation. Computación y Sistemas, 22(2), 347–361.
 * https://doi.org/10.13053/CyS-22-2-2951
 *
 * <p>Segura, C., Hernandez-Aguirre, A., Luna, F., & Alba, E. (2017). Improving Diversity in
