...
/** JUnit test cases for the classes that implement Initializer for the BitVector class. */
public class BitVectorInitializerTests {

  @Test
  public void testExceptions() {
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new BitVectorInitializer(-1));
  }
