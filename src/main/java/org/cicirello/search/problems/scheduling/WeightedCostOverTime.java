...
/**
 * This is an implementation of the weighted COVERT heuristic. COVERT is an abbreviation for Cost
 ...
 * calculation of the slack of job j where slack S(j) is d[j] - T - p[j] - s[j]. The d[j] is the
 * job's due date, T is the current time, and s[j] is any setup time of the job (for problems with
