...
/** JUnit test cases for the classes that implement Initializer for the RealValued classes. */
public class RealValuedInitializerTests {
  ...
  public void testBoundedRealVectorEquals() {
    RealVectorInitializer f =
        new RealVectorInitializer(
            new double[] {2, 2},
  ...
  public void testUnivariate() {
    ...
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new RealValueInitializer(5, 5));
    thrown =
        assertThrows(IllegalArgumentException.class, () -> new RealValueInitializer(5, 5, 2, 6));
    thrown =
        assertThrows(IllegalArgumentException.class, () -> new RealValueInitializer(5, 6, 7, 6));
  }
  ...
  public void testExceptions() {
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new RealVectorInitializer(1, 5, 5));
    final double[] a1 = {1};
    final double[] a2 = {2, 1};
    final double[] b2 = {2, 3};
    thrown = assertThrows(IllegalArgumentException.class, () -> new RealVectorInitializer(a1, b2));
    thrown = assertThrows(IllegalArgumentException.class, () -> new RealVectorInitializer(a2, b2));
    thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new RealVectorInitializer(1, 5, 5, 2, 6));
    thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new RealVectorInitializer(1, 4, 5, 7, 6));
    thrown =
        assertThrows(IllegalArgumentException.class, () -> new RealVectorInitializer(a1, b2, 2, 6));
    thrown =
        assertThrows(IllegalArgumentException.class, () -> new RealVectorInitializer(a2, b2, 7, 6));
    thrown =
        assertThrows(IllegalArgumentException.class, () -> new RealVectorInitializer(a2, b2, 2, 6));
    final double[] min1 = {1};
    final double[] min2 = {1, 1};
    final double[] max2 = {2, 2};
    thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new RealVectorInitializer(a1, b2, min2, max2));
    thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new RealVectorInitializer(a2, b2, min1, max2));
    thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new RealVectorInitializer(a2, b2, min2, max2));
    a2[0] = 1;
    min2[0] = 3;
    thrown =
        assertThrows(
