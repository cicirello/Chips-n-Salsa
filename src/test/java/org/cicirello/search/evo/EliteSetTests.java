...
public class EliteSetTests {
  ...
  public void testIncreasingFitnessDouble() {
    for (int numElite = 1; numElite <= 5; numElite++) {
      ArrayList<PopulationMember.DoubleFitness<TestObject>> addThese =
          new ArrayList<PopulationMember.DoubleFitness<TestObject>>();
      for (int i = 1; i <= 10; i++) {
      ...
      // Try adding them again to make sure doesn't change anything (e.g., shouldn't allow
      // duplicates).
  ...
  public void testIncreasingFitnessInteger() {
    for (int numElite = 1; numElite <= 5; numElite++) {
      ArrayList<PopulationMember.IntegerFitness<TestObject>> addThese =
          new ArrayList<PopulationMember.IntegerFitness<TestObject>>();
      for (int i = 1; i <= 10; i++) {
