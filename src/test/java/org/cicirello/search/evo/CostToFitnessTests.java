...
/** JUnit test cases for cost to fitness transformations. */
public class CostToFitnessTests {
  ...
  public void testNegativeCostFitnessFunction() {
    ...
    NegativeCostFitnessFunction<TestObject> fitness =
        new NegativeCostFitnessFunction<TestObject>(problem);
    for (int i = -2; i <= 2; i++) {
  ...
  public void testNegativeIntegerCostFitnessFunction() {
    ...
    NegativeIntegerCostFitnessFunction<TestObject> fitness =
        new NegativeIntegerCostFitnessFunction<TestObject>(problem);
    for (int i = -2; i <= 2; i++) {
  ...
  public void testInverseDoubleToFitness1() {
    ...
    InverseCostFitnessFunction<TestObject> fitness =
        new InverseCostFitnessFunction<TestObject>(problem);
    assertTrue(problem == fitness.getProblem());
    ...
    thrown =
        assertThrows(
            IllegalArgumentException.class,
            () ->
                new InverseCostFitnessFunction<TestObject>(
                    new TestProblemDouble(Double.POSITIVE_INFINITY)));
  }
  ...
  public void testInverseDoubleToFitness2() {
    TestProblemDouble problem = new TestProblemDouble(0);
    InverseCostFitnessFunction<TestObject> fitness =
        new InverseCostFitnessFunction<TestObject>(problem, 2);
    assertTrue(problem == fitness.getProblem());
    assertEquals(1.0, fitness.fitness(new TestObject(0)), 1E-10);
    assertEquals(0.5, fitness.fitness(new TestObject(2)), 1E-10);
  ...
  public void testInverseIntegerToFitness1() {
    ...
    thrown =
        assertThrows(
            ...
            () ->
                new InverseCostFitnessFunction<TestObject>(
                    new TestProblemInteger(Integer.MAX_VALUE)));
    thrown =
        assertThrows(
            IllegalArgumentException.class,
            () ->
                new InverseCostFitnessFunction<TestObject>(
                    new TestProblemInteger(Integer.MIN_VALUE)));
  }
