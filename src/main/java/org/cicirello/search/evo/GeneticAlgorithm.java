 ...
 * form of GA known as the Simple GA, the {@link MutationOnlyGeneticAlgorithm} class if all you want
 * to use is mutation and no crossover, and the {@link GenerationalEvolutionaryAlgorithm} class if
...
public class GeneticAlgorithm extends GenerationalEvolutionaryAlgorithm<BitVector> {
   ...
   * @throws NullPointerException if any of crossover, initializer, f, selection, or tracker are
   *     null.
   */
   ...
   * using the standard bit flip mutation. All other characteristics, such as crossover operator and
   * selection operator are configurable. This constructor supports fitness functions with fitnesses
   * of type int, the {@link FitnessFunction.Integer} interface.
   *
   * @param n The population size.
   * @param initializer An initializer for generating random initial population members.
   * @param f The fitness function.
