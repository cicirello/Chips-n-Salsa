...
public interface Metaheuristic<T extends Copyable<T>> extends TrackableSearch<T> {
  ...
  /**
   * Executes a run of the metaheuristic beginning at a randomly generated solution. If this method
   * is called multiple times, each call begins at a new randomly generated starting solution, and
   * reinitializes any control parameters of the metaheuristic that may have changed during the
   * previous call to optimize to start of run state.
   *
