...
public interface TSPEdgeDistance {
  ...
  /**
   * Computes the distance between two cities in the TSP as an integer. Some of the commonly used
   * distance functions in TSP benchmark problem sets assume integer costs, such as Euclidean
   * distance between the end points of an edge rounded to the nearest integer. The default
   * implementation of this method rounds the result of a call to distance(i, j) to the nearest
   * integer.
   *
   * @param x1 The x coordinate of the first city.
   * @param y1 The y coordinate of the first city.
