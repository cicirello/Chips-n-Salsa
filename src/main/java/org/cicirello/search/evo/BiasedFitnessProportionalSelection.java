 ...
 * to transform the fitness values. In this biased fitness proportional selection, a member of the
 * population is chosen randomly with probability proportional to a bias function of its fitness
 * relative to the total of such biased fitness of the population. For example, if the fitness of
 * population member i is f<sub>i</sub>, then the probability of selecting population member i is:
 * bias(f<sub>i</sub>) / &sum;<sub>j</sub> bias(f<sub>j</sub>), for j &isin; { 1, 2, ..., N }, where
 * N is the population size, and bias is a bias function. To select M members of the population, M
 * independent random decisions are executed in this way, thus requiring generating M random numbers
 * of type double.
 *
 ...
 *
 * <p>For the more common standard version of fitness proportional selection, see the {@link
 * FitnessProportionalSelection} class.
 *
 * @author <a href=https://www.cicirello.org/ target=_top>Vincent A. Cicirello</a>, <a
 *     href=https://www.cicirello.org/ target=_top>https://www.cicirello.org/</a>
 */
public class BiasedFitnessProportionalSelection extends FitnessProportionalSelection {
