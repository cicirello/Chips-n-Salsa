...
/**
 * This class is used by the {@link BinPackingSolution} class to represent the contents of a bin in
 * a solution to a {@link BinPacking} problem instance. Although you cannot construct instances of
 * it directly (it doesn't have a public constructor), you can use the methods of this class to
