 ...
 *
 * <p>Many such algorithms start with a randomized initial candidate solution, while some start with
 * a heuristic solution. Classes that implement this interface serve that functionality.
 *
