...
public final class GeneticAlgorithm extends GenerationalEvolutionaryAlgorithm<BitVector> {
	...
	public GeneticAlgorithm(int n, int bitLength, FitnessFunction.Double<BitVector> f, double mutationRate, CrossoverOperator<BitVector> crossover, double crossoverRate, SelectionOperator selection, ProgressTracker<BitVector> tracker) {
		super(n, new BitFlipMutation(mutationRate), mutationRate > 0.0 ? 1.0 : 0.0, crossover, crossoverRate, new BitVectorInitializer(bitLength), f, selection, tracker);
	}
	...
	// The Simple GA: bit flip mutation, single-point crossover, and fitness proportionate selection.
	 ...
	 */
	public GeneticAlgorithm(int n, int bitLength, FitnessFunction.Double<BitVector> f, double mutationRate, double crossoverRate, ProgressTracker<BitVector> tracker) {
		super(n, new BitFlipMutation(mutationRate), mutationRate > 0.0 ? 1.0 : 0.0, new SinglePointCrossover(), crossoverRate, new BitVectorInitializer(bitLength), f, new FitnessProportionalSelection(), tracker);
	}
	 ...
	 * @throws NullPointerException if any of f, or tracker are null.
	 */
	public GeneticAlgorithm(int n, int bitLength, FitnessFunction.Integer<BitVector> f, double mutationRate, double crossoverRate, ProgressTracker<BitVector> tracker) {
		super(n, new BitFlipMutation(mutationRate), mutationRate > 0.0 ? 1.0 : 0.0, new SinglePointCrossover(), crossoverRate, new BitVectorInitializer(bitLength), f, new FitnessProportionalSelection(), tracker);
	}
	
	// Mutation-only GA, with Initializer.
	 ...
	 */
	public GeneticAlgorithm(int n, Initializer<BitVector> initializer, FitnessFunction.Double<BitVector> f, double mutationRate, SelectionOperator selection, ProgressTracker<BitVector> tracker) {
	 ...
	 * @throws NullPointerException if any of initializer, f, selection, or tracker are null.
	 */
	public GeneticAlgorithm(int n, Initializer<BitVector> initializer, FitnessFunction.Integer<BitVector> f, double mutationRate, SelectionOperator selection, ProgressTracker<BitVector> tracker) {
		super(n, new BitFlipMutation(mutationRate), mutationRate > 0.0 ? 1.0 : 0.0, initializer, f, selection, tracker);
	}
	
	// Mutation-only GA, with bitLength specified.
	 ...
	 */
	public GeneticAlgorithm(int n, int bitLength, FitnessFunction.Double<BitVector> f, double mutationRate, SelectionOperator selection, ProgressTracker<BitVector> tracker) {
		super(n, new BitFlipMutation(mutationRate), mutationRate > 0.0 ? 1.0 : 0.0, new BitVectorInitializer(bitLength), f, selection, tracker);
	}
	 ...
	 * @throws NullPointerException if any of f, selection, or tracker are null.
	 */
	public GeneticAlgorithm(int n, int bitLength, FitnessFunction.Integer<BitVector> f, double mutationRate, SelectionOperator selection, ProgressTracker<BitVector> tracker) {
		super(n, new BitFlipMutation(mutationRate), mutationRate > 0.0 ? 1.0 : 0.0, new BitVectorInitializer(bitLength), f, selection, tracker);
	}
	 ...
	 */
	private GeneticAlgorithm(GeneticAlgorithm other) {
		super(other);
