...
[<img alt="Chips-n-Salsa - A Java library of customizable, hybridizable, iterative, parallel, stochastic, and self-adaptive local search algorithms" 
     src="docs/images/chips-n-salsa.png" width="640">](#chipsnsalsa-a-java-library-of-customizable-hybridizable-iterative-parallel-stochastic-and-selfadaptive-local-search-algorithms)
