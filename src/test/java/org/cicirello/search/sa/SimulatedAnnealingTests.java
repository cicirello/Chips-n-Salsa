...
public class SimulatedAnnealingTests {
  ...
  public void setUp() {
    ...
    d_unknown =
        new SimulatedAnnealing<TestObject>(pd_unknown, new TestMutation(), new TestInitializer());
    d_known =
        new SimulatedAnnealing<TestObject>(pd_known, new TestMutation(), new TestInitializer());
    i_unknown =
        new SimulatedAnnealing<TestObject>(pi_unknown, new TestMutation(), new TestInitializer());
    i_known =
        new SimulatedAnnealing<TestObject>(pi_known, new TestMutation(), new TestInitializer());
  }
  ...
  public void testConstructors() {
    ...
    SimulatedAnnealing<TestObject> sa =
        new SimulatedAnnealing<TestObject>(pi_known, mutation, init, anneal, tracker);
    sa.optimize(1);
  ...
  public void testStopFromAnotherThread() {
    ...
    ProgressTracker<TestObject> tracker = new ProgressTracker<TestObject>();
    SimulatedAnnealing<TestObject> sa =
        new SimulatedAnnealing<TestObject>(pi_unknown, mutation, init, anneal, tracker);
