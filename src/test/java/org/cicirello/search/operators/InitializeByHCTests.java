...
public class InitializeByHCTests {
	...
	public void testIntSteepest() {
		...
		SteepestDescentHillClimber<TestObject> hc = new SteepestDescentHillClimber<TestObject>(problem, new TestMutator(), new TestObject(1000));
		
		InitializeBySimpleMetaheuristic<TestObject> init = new InitializeBySimpleMetaheuristic<TestObject>(hc);
	...
	public void testIntFirst() {
		TestObject.setB(0);
		TestOptInt problem = new TestOptInt();
		FirstDescentHillClimber<TestObject> hc = new FirstDescentHillClimber<TestObject>(problem, new TestMutator(), new TestObject(1000));
