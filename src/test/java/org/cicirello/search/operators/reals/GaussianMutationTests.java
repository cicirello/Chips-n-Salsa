...
/**
 * JUnit test cases for the classes that implement different variations of Gaussian mutation for
...
public class GaussianMutationTests extends SharedTestRealMutationOps {
  ...
  public void testExceptions() {
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class, () -> GaussianMutation.createGaussianMutation(1.0, 0));
    thrown =
        assertThrows(
  ...
  public void testConstrainedGaussianMutation() {
    ...
    // copy
    {
      GaussianMutation<RealValued> g1 =
          GaussianMutation.createGaussianMutation(1.0, -10.0, 10.0).copy();
      assertEquals(1.0, g1.get(0));
      verifyMutate1(g1);

      GaussianMutation<RealValued> g5 =
          GaussianMutation.createGaussianMutation(5.0, -10.0, 10.0).copy();
      assertEquals(5.0, g5.get(0));
      verifyMutate1(g5);

      GaussianMutation<RealValued> g =
          GaussianMutation.createGaussianMutation(1.0, 2.0, 5.0).copy();
      RealVector r = new RealVector(new double[] {-1000, -100, -50, 0.0, 3.0, 50, 100, 1000});
      g.mutate(r);
      assertEquals(2.0, r.get(0));
      assertEquals(2.0, r.get(1));
    ...
    {
      GaussianMutation<RealValued> g1 =
          GaussianMutation.createGaussianMutation(1.0, -10.0, 10.0).split();
      assertEquals(1.0, g1.get(0));
      verifyMutate1(g1);

      GaussianMutation<RealValued> g5 =
          GaussianMutation.createGaussianMutation(5.0, -10.0, 10.0).split();
      assertEquals(5.0, g5.get(0));
      verifyMutate1(g5);

      GaussianMutation<RealValued> g =
          GaussianMutation.createGaussianMutation(1.0, 2.0, 5.0).split();
      RealVector r = new RealVector(new double[] {-1000, -100, -50, 0.0, 3.0, 50, 100, 1000});
      g.mutate(r);
      assertEquals(2.0, r.get(0));
      assertEquals(2.0, r.get(1));
  ...
  public void testUndoableConstrainedGaussianMutation() {
    UndoableGaussianMutation<RealValued> g1 =
        UndoableGaussianMutation.createGaussianMutation(1.0, -10.0, 10.0);
    assertEquals(1.0, g1.get(0));
    verifyMutate1(g1);
    verifyUndo(g1);

    UndoableGaussianMutation<RealValued> g5 =
        UndoableGaussianMutation.createGaussianMutation(5.0, -10.0, 10.0);
    assertEquals(5.0, g5.get(0));
    verifyMutate1(g5);
    verifyUndo(g5);

    UndoableGaussianMutation<RealValued> g =
        UndoableGaussianMutation.createGaussianMutation(1.0, 2.0, 5.0);
    RealVector r = new RealVector(new double[] {-1000, -100, -50, 0.0, 3.0, 50, 100, 1000});
    g.mutate(r);
    assertEquals(2.0, r.get(0));
    assertEquals(2.0, r.get(1));
  ...
  public void testPartialGaussianMutation1() {
    for (int k = 1; k <= 8; k++) {
      UndoableGaussianMutation<RealValued> g1 =
          UndoableGaussianMutation.createGaussianMutation(1.0, k);
      assertEquals(1.0, g1.get(0), EPSILON);
      verifyMutate1(g1, k);
      verifyUndo(g1);

      UndoableGaussianMutation<RealValued> g5 =
          UndoableGaussianMutation.createGaussianMutation(5.0, k);
      assertEquals(5.0, g5.get(0), EPSILON);
      verifyMutate1(g5, k);
      verifyUndo(g5);
