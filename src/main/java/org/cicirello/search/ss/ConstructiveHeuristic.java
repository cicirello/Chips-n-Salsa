 ...
 * algorithms.
 *
 * @param <T> The type of Partial object for which this ConstructiveHeuristic guides construction,
...
public interface ConstructiveHeuristic<T extends Copyable<T>> {
   ...
   *
   * <p>The default implementation simply returns null, which is appropriate for heuristics that
