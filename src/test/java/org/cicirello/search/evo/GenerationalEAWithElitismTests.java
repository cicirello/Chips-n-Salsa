 ...
 * parameter, but with elitism.
 */
public class GenerationalEAWithElitismTests {
  ...
  public void testBothOpsDoubleFitness() {
    ...
    GenerationalEvolutionaryAlgorithm<TestObject> ea =
        new GenerationalEvolutionaryAlgorithm<TestObject>(
            N + E, mutation, 0.5, crossover, 0.5, initializer, f, selection, E);
    ...
    assertNotNull(solution);
    assertEquals(2 * N + 2 * E, initializer.count);
    ...
    assertEquals(f.count, 2 * N + 2 * E + mutation.count + crossover.count);
    assertEquals((long) f.count, ea.getTotalRunLength());
  ...
  public void testBothOpsAlwaysMutateDoubleFitness() {
    ...
    GenerationalEvolutionaryAlgorithm<TestObject> ea =
        new GenerationalEvolutionaryAlgorithm<TestObject>(
            N + E, mutation, 1.0, crossover, 0.5, initializer, f, selection, E);
  ...
  public void testBothOps_1_0_DoubleFitness() {
    ...
    GenerationalEvolutionaryAlgorithm<TestObject> ea =
        new GenerationalEvolutionaryAlgorithm<TestObject>(
            N + E, mutation, 1.0, crossover, 1.0, initializer, f, selection, E);
  ...
  public void testMutationOnlyDoubleFitness() {
    ...
    GenerationalMutationOnlyEvolutionaryAlgorithm<TestObject> ea =
        new GenerationalMutationOnlyEvolutionaryAlgorithm<TestObject>(
            N + E, mutation, 0.5, initializer, f, selection, E);
    ...
    assertEquals(N + E, initializer.count);
    assertTrue(mutation.count > 0 && mutation.count < 3 * N);
    assertEquals(f.count, N + E + mutation.count);
    assertEquals((long) f.count, ea.getTotalRunLength());
    assertEquals(3, selection.calledCount);
    assertEquals(tracker.getSolutionCostPair().getSolution(), solution.getSolution());
    assertTrue(tracker.getSolutionCostPair().getSolution() != solution.getSolution());
    ...
    assertEquals(2 * N + 2 * E, initializer.count);
    assertTrue(mutation.count > oldMutationCount && mutation.count < 10 * N);
    assertEquals(f.count, 2 * N + 2 * E + mutation.count);
    assertEquals((long) f.count, ea.getTotalRunLength());
    assertEquals(10, selection.calledCount);
    assertEquals(3, selection.initCount);
  ...
  public void testAlwaysDoubleFitness() {
    ...
    GenerationalMutationOnlyEvolutionaryAlgorithm<TestObject> ea =
        new GenerationalMutationOnlyEvolutionaryAlgorithm<TestObject>(
            N + E, mutation, 1.0, initializer, f, selection, E);
  ...
  public void testBothOpsDoubleFitness_Mutual() {
    ...
    GenerationalEvolutionaryAlgorithmMutuallyExclusiveOperators<TestObject> ea =
        new GenerationalEvolutionaryAlgorithmMutuallyExclusiveOperators<TestObject>(
            N + E, mutation, 0.25, crossover, 0.25, initializer, f, selection, E);
  ...
  public void testBothOps_MutualAllCross_DoubleFitness() {
    ...
    GenerationalEvolutionaryAlgorithmMutuallyExclusiveOperators<TestObject> ea =
        new GenerationalEvolutionaryAlgorithmMutuallyExclusiveOperators<TestObject>(
            N + E, mutation, 0.0, crossover, 1.0, initializer, f, selection, E);
