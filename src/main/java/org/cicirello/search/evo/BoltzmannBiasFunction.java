 ...
 */
abstract class BoltzmannBiasFunction
    implements FitnessBiasFunction, Splittable<BoltzmannBiasFunction> {
  ...
  @Override
  public final double bias(double fitness) {
   ...
   */
  public abstract double nextT(double t);
}
