...
/**
 * Implementation of single point crossover, a classic crossover operator for BitVectors. In a
 * single point crossover, a random cross point is chosen uniformly along the length of the bit
 * vector parents. Both parents are cut at that point. Each child gets the bits before the cross
 * point from one parent, and the bits after the cross point from the other parent.
 *
