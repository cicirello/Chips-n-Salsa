 ...
 *
 * <p>In logarithmic cooling, the k-th temperature is defined as: t<sub>k</sub> = c / ln(k + d),
 ...
 * the cooling schedule as: t<sub>k</sub> = t<sub>0</sub> / ln(k + e), where e is the base of the
 * natural logarithm.
 *
