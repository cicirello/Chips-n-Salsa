  ...
  public void testDoubleFitnessBitLength() {
    ...
    thrownNull =
        assertThrows(
            ...
            () ->
                new MutationOnlyGeneticAlgorithm(
                    n, L, new InverseCostFitnessFunction<BitVector>(problem), M, null, tracker));
    thrownNull =
        assertThrows(
            NullPointerException.class,
            () ->
  ...
  public void testDoubleFitnessBitLengthNoTracker() {
    ...
    thrownNull =
        assertThrows(
            ...
            () ->
                new MutationOnlyGeneticAlgorithm(
                    n, L, new InverseCostFitnessFunction<BitVector>(problem), M, null));
  }
  ...
  public void testIntegerFitnessBitLengthNoTracker() {
    ...
    thrownNull =
        assertThrows(
            ...
            () ->
                new MutationOnlyGeneticAlgorithm(
                    n, L, new NegativeIntegerCostFitnessFunction<BitVector>(problem), M, null));
  }
