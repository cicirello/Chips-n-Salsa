...
public class SimulatedAnnealingHCTests {
	 ...
	 */	 
	private static class NoHillClimber implements Metaheuristic<TestObject>, SimpleLocalMetaheuristic<TestObject> {
		...
		public NoHillClimber split() {
			if (optInt!=null)
				return new NoHillClimber(optInt);
			else
				return new NoHillClimber(opt);
		}
		@Override
		...
		@Override
		public long getTotalRunLength() {return 0; }
		@Override
		public void setProgressTracker(ProgressTracker<TestObject> tracker) {/* not needed for tests */}
		@Override
	...
	private static class TestDoNothingMutation implements UndoableMutationOperator<TestObject>, IterableMutationOperator<TestObject> {
		@Override public void mutate(TestObject c) { }
		@Override public void undo(TestObject c) { }
		@Override public TestDoNothingMutation split() { return new TestDoNothingMutation(); }
		@Override public MutationIterator iterator(TestObject c) { return new TestMutationIterator(c); }
	}
	...
	private static class TestMutationIterator implements MutationIterator {
		...
		@Override
		public void nextMutant() { if (hasNext()) { c.bar++; callCount++; } }
		@Override
		public void setSavepoint() { save = c.bar; }
		@Override
		public void rollback() { c.bar = save; }
	}
