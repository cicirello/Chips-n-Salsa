  ...
  public void testConstructor() {
    for (int n = 0; n < 3; n++) {
      ...
      ArrayIndexOutOfBoundsException thrown =
          assertThrows(ArrayIndexOutOfBoundsException.class, () -> partial.getExtension(m));
    }
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new PartialPermutation(-1));
  }
  ...
  public void testExtend() {
    for (int n = 1; n < 5; n++) {
      ...
      for (int i = 0; i < n; i++) {
        ...
        final int k = i;
        thrown = assertThrows(ArrayIndexOutOfBoundsException.class, () -> partial.get(k));
    ...
    for (int n = 1; n < 5; n++) {
      ...
      for (int i = 0; i < n; i++) {
        ...
        final int m = n - i - 1;
        ArrayIndexOutOfBoundsException thrown =
            assertThrows(ArrayIndexOutOfBoundsException.class, () -> partial.extend(m));
      }
      assertTrue(partial.isComplete());
      assertEquals(0, partial.numExtensions());
      assertEquals(n, partial.size());
