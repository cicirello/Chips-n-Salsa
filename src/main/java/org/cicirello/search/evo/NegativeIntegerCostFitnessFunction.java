 ...
 * that implements either {@link org.cicirello.search.problems.OptimizationProblem
 * OptimizationProblem} or {@link IntegerCostOptimizationProblem}. However, the evolutionary
 ...
 * such as {@link FitnessProportionalSelection} and {@link StochasticUniversalSampling}.
 *
 * <p>This class transforms the cost of solution s to fitness with the following transformation:
 * fitness(s) = -cost(s), where cost(s) refers to the {@link IntegerCostOptimizationProblem#cost}
 * method.
 *
 ...
 */
public final class NegativeIntegerCostFitnessFunction<T extends Copyable<T>>
    implements FitnessFunction.Integer<T> {
