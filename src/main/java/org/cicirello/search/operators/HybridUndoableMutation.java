 ...
 * the available mutation operators. This implementation supports the {@link #undo} method.
 *
...
public final class HybridUndoableMutation<T> implements UndoableMutationOperator<T> {
  ...
  public void mutate(T c) {
    mutationOps.get(last = generator.nextBiasedInt(mutationOps.size())).mutate(c);
  }
