...
public interface ConstructiveHeuristic<T extends Number> {
	 ...
	 * end of a PartialPermutation.  Higher evaluations imply that the element is
	 ...
	 * @param element The element under consideration for adding to the PartialPermutation
