 ...
 * sequence-dependent setups.</p>
 *
 * <p>The heuristic is essentially that of 
 * {@link WeightedShortestProcessingTimeLateOnly}, but using the
 * setup time adjustment also used by 
 * {@link WeightedShortestProcessingPlusSetupTime}.</p>
 *
