 ...
 * without ProgressTracker parameter, but with elitism.
 */
public class GenerationalEAWithElitismTests {
	...
	public void testBothOpsDoubleFitness_Mutual() {
		...
		GenerationalEvolutionaryAlgorithmMutuallyExclusiveOperators<TestObject> ea = new GenerationalEvolutionaryAlgorithmMutuallyExclusiveOperators<TestObject>(
			N+E, 
			mutation, 
			0.25,
			crossover,
