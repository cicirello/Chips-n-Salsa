...
public class CrossoverTests {
  ...
  public void testUniformCrossoverBounded() {
    ...
    UniformCrossover<BoundedRealVector> crossoverDefault =
        new UniformCrossover<BoundedRealVector>();
  ...
  public void testSinglePoint() {
    ...
    SinglePointCrossover<BoundedRealVector> crossoverBounded =
        new SinglePointCrossover<BoundedRealVector>();
  ...
  public void testTwoPoint() {
    ...
    TwoPointCrossover<BoundedRealVector> crossoverBounded =
        new TwoPointCrossover<BoundedRealVector>();
  ...
  public void testKPoint1() {
    ...
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new KPointCrossover<RealVector>(0));
  }
  ...
  private void validateMultiPointCrossover(
      CrossoverOperator<RealVector> crossover, int expectedCrossPoints) {
  ...
  private void validateMultiPointCrossoverBounded(
      CrossoverOperator<BoundedRealVector> crossover, int expectedCrossPoints) {
    for (int n = Math.max(2, expectedCrossPoints); n <= 32; n *= 2) {
      double[] a1 = new double[n];
      double[] a2 = new double[n];
      for (int i = 0; i < n; i++) {
