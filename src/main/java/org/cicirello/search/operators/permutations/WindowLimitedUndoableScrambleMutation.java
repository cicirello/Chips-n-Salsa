 ...
 */
public final class WindowLimitedUndoableScrambleMutation
  ...
  /**
   * Constructs a WindowLimitedUndoableScrambleMutation mutation operator with the undo method
   * enabled.
   *
