...
public final class CommonDuedateScheduling implements SingleMachineSchedulingProblemData {
	...
	/**
	 * <p>Outputs a description of the instance in the format
	 * described by the 
	 * <a href=http://people.brunel.ac.uk/~mastjjb/jeb/orlib/schinfo.html>OR-Library 
	 * of J.E. Beasley</a>.
	 * The <a href=https://github.com/cicirello/scheduling-benchmarks/tree/master/common-due-date>description</a>, 
	 ...
	 * <a href=https://github.com/cicirello/scheduling-benchmarks>https://github.com/cicirello/scheduling-benchmarks</a></p>
	 *
	 * <p>The first line of the file that this produces has the number of instances in the file,
	 * which will be equal to 1 since this only outputs a single instance. Although this may seem
	 * unnecessary, it is included to enable using the same parser for the files from the OR-Library
	 * as well as for those generated by this method.
	 * The second line indicates the number of jobs n.
