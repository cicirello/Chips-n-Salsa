...
public class SchedulingWithVBSS {
	...
	public static void main(String[] args) {
		...
		ValueBiasedStochasticSampling<Permutation> vbss = new ValueBiasedStochasticSampling<Permutation>(heuristic, 8);
		...
		FirstDescentHillClimber<Permutation> hybrid = new FirstDescentHillClimber<Permutation>(
			...
			new InitializeBySimpleMetaheuristic<Permutation>(new ValueBiasedStochasticSampling<Permutation>(heuristic, 8))
		);
