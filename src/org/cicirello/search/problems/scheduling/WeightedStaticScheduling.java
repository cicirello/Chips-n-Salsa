 ...
 * to generate the benchmark instances for weighted tardiness scheduling
 * that are available in 
 * the <a href=http://people.brunel.ac.uk/~mastjjb/jeb/orlib/wtinfo.html>OR-Library 
 ...
 * That <a href=https://github.com/cicirello/scheduling-benchmarks/tree/master/wt>description</a>, 
 ...
 * problem instance data (e.g., processing times, weights, etc) from the
...
public final class WeightedStaticScheduling implements SingleMachineSchedulingProblemData {
	 ...
	 * [MIN_PROCESS_TIME, MAX_PROCESS_TIME].
	 */
	public final static int MAX_PROCESS_TIME = 100;
	 ...
	 * <a href=http://people.brunel.ac.uk/~mastjjb/jeb/orlib/wtinfo.html>OR-Library 
	 * of J.E. Beasley</a>.
	 ...
	 * <a href=https://github.com/cicirello/scheduling-benchmarks>https://github.com/cicirello/scheduling-benchmarks</a></p>
	 *
	 * <p>The format from the benchmark library is a bit unusual. 
	 * Each file contains many instances.  There is no labeling info, 
	 * so you need to know the number of jobs, n, contained in the file.
	 * The first instance is listed first with n process times, 
	 * followed by n weights, followed by n duedates. This is then followed 
	 * by second instance (n process times, n weights, and then n duedates), etc,  
	 * with no instance separators.</p>
	 *
	 * @param filename The name of the file containing the instances, with path.
	 * @param n The number of jobs in one instance.  Behavior is undefined if n
	 * is inconsistent with the actual number of jobs of the instances contained in the file.
	 * @param instanceNumber The number of the instance to parse, where the first instance
	 * is instance 0. Behavior is undefined if instanceNumber is too high.
	 ...
	 * <a href=https://github.com/cicirello/scheduling-benchmarks>https://github.com/cicirello/scheduling-benchmarks</a></p>
	 *
	 * <p>The only different with that format is that this stores only the one instance
	 * in the file.  But for consistency with the original format, you do need to know
	 * the number of jobs for the instance (or you can determine this by counting number
	 * of integers in the file and dividing by 3.</p>
	 *
