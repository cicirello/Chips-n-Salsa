 ...
 * geometric cooling). In this cooling schedule, the k-th temperature, t<sub>k</sub>, is determined
 * as follows: t<sub>k</sub> = &alpha;<sup>k</sup> * t<sub>0</sub>, where t<sub>0</sub> is the
 * initial temperature and &alpha; is the cooling rate. The new temperature is usually computed
 ...
 *
 * <p>Additionally, this class stops updating the temperature once it is less than or equal to
