 ...
 * some objective function.  In this hybrid, the hill climb executes first, and simulated 
 * annealing is used to further optimize the hill climber's solution.   
 ...
 */
public class PreHillclimbExample {
	...
	public static void main(String[] args) {
		...
		// The hill climber needs a simple initializer that generates random solutions.
		// The parameter indicates the length of the permutations to generate.
		PermutationInitializer initHC = new PermutationInitializer(N);
		
		// The library has the two most common hill climbers available, First Descent, and
		// Steepest Descent.
		SteepestDescentHillClimber<Permutation> hc = new SteepestDescentHillClimber<Permutation>(problem, mutation, initHC);
		
		// To start simulated annealing with local optima generated by hill climbing,
		// we can use the InitializeBySimpleMetaheuristic class, which implements the
		// Initializer interface using a hill climber on random starting solutions.
		// We'll then give this InitializeBySimpleMetaheuristic to the SimulatedAnnealing
		// class as its Initializer.
		InitializeBySimpleMetaheuristic<Permutation> initializer = new InitializeBySimpleMetaheuristic<Permutation>(hc);  
		
		// Create the simulated annealer, giving it the problem to solve, the 
		// mutation operator, and the initializer.  
		...
		SimulatedAnnealing<Permutation> sa = SimulatedAnnealing.createInstance(problem, mutation, initializer);
