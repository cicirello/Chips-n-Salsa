...
/**
 * JUnit test cases for FitnessProportionalSelection and StochasticUniversalSampling, as well as the
 * Biased versions of these.
 */
public class FitnessProportionalSelectionTests extends SharedTestSelectionOperators {
  ...
  public void testBiasedFitnessProportionalSelection() {
    BiasedFitnessProportionalSelection selection =
        new BiasedFitnessProportionalSelection(x -> x * x);
    validateIndexes_Double(selection);
    validateIndexes_Integer(selection);
