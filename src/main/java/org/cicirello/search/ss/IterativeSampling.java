...
/**
 * Iterative sampling is the simplest possible form of a stochastic sampling search. In iterative
 * sampling, the search generates N random candidate solutions to the problem, each sampled
 * uniformly at random from the space of possible solutions. It evaluates each of the N candidate
 * solutions with respect to the optimization problem's cost function, and returns the best of the N
 * candidate solutions.
 *
 * <p>For an early empirical comparison of iterative sampling with systematic search algorithms,
 * see:<br>
 * P. Langley. Systematic and nonsystematic search strategies. Proceedings of the First
 * International Conference on Artificial Intelligence Planning Systems, pages 145–152, 1992.
 *
...
public final class IterativeSampling<T extends Copyable<T>> extends AbstractStochasticSampler<T> {
  ...
  /**
   * Constructs an iterative sampling search for a real-valued optimization problem. A {@link
  ...
  /**
   * Constructs an iterative sampling search for a integer-valued optimization problem. A {@link
   * ProgressTracker} is created for you.
   *
   * @param problem An instance of an optimization problem to solve.
   * @param initializer The source of random solutions.
