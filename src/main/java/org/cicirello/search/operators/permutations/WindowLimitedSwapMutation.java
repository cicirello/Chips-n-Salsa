 ...
 * {@link SwapMutation} mutation operator on permutations.  A window-limited
 ...
 * since only 2 elements must be moved regardless of permutation length and window limit.</p>
 *
...
public final class WindowLimitedSwapMutation extends SwapMutation {
	...
	/**
	 * Constructs a WindowLimitedSwapMutation mutation operator with
