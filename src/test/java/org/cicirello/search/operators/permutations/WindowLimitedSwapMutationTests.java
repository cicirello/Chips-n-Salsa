...
/** JUnit test cases for WindowLimitedSwapMutation. */
public class WindowLimitedSwapMutationTests extends PermutationMutationValidator {

  @Test
  public void testException() {
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new WindowLimitedSwapMutation(0));
  }
