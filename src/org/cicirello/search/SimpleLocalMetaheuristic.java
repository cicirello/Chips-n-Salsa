...
public interface SimpleLocalMetaheuristic<T extends Copyable<T>> extends SimpleMetaheuristic<T> {
	 ...
	 * (e.g., a hill climber that terminates when it reaches a local optima), 
	 * beginning at a specified solution.
	 * If this method is called multiple times, each call 
	 * reinitializes any control parameters  
