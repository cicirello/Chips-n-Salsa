...
/**
 * This class implements the Cycle(&alpha;) form of cycle mutation on permutations, where one
 ...
 * of length 3.
 *
 * <p>The Cycle(&alpha;) version of cycle mutation chooses the cycle size randomly from {2, 3, ...,
 * n} where cycle length k is chosen with probability proportional to &alpha;<sup>k-2</sup>. It then
 ...
 * swap.
 *
 * <p>The worst case runtime of a single call to the {@link #mutate(Permutation) mutate} method is
 ...
 * ((2-&alpha;)/(1-&alpha;))<sup>2</sup>)). Thus, provided &alpha; is not close to 1, the average
 * runtime is a constant depending upon the value of &alpha;.
 *
 * <p>Cycle mutation in both of its forms, including Cycle(&alpha;), was introduced in the following
 * article:
 *
