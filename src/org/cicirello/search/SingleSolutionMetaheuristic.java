 ...
 * such as genetic algorithms.  It is also specifically focused on 
...
public interface SingleSolutionMetaheuristic<T extends Copyable<T>> extends ReoptimizableMetaheuristic<T> {
	...
	/**
	 * <p>Executes a run of the metaheuristic beginning at a specified starting solution.
	 * If this method is called multiple times, each call begins by reinitializing 
	 * the metaheuristic's control parameters.
	 * as if it was a fresh run.</p>
	 *
	 ...
	 * It is also recommended that implementing classes rename the runLength parameter to be a more
	 ...
	 * in this metaheuristic's {@link ProgressTracker}, 
