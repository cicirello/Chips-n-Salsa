...
/** JUnit tests for the RandomTSPMatrix.Integer class. */
public class RandomTSPIntegerMatrixTests {
  ...
  public void testIntegerConstructor1() {
    ...
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new RandomTSPMatrix.Integer(1, 1));
    thrown = assertThrows(IllegalArgumentException.class, () -> new RandomTSPMatrix.Integer(2, 0));
  }
  ...
  public void testIntegerConstructor2() {
    ...
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new RandomTSPMatrix.Integer(1, 1, true));
    thrown =
        assertThrows(IllegalArgumentException.class, () -> new RandomTSPMatrix.Integer(2, 0, true));
  }
  ...
  public void testIntegerConstructor3() {
    ...
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new RandomTSPMatrix.Integer(1, 1, true, false));
    thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new RandomTSPMatrix.Integer(2, 0, true, false));
  }
  ...
  public void testIntegerTSPMatrix() {
    ...
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new RandomTSPMatrix.Integer(new int[1][1]));
    thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new RandomTSPMatrix.Integer(new int[4][5]));
  }
