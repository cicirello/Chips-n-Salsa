 ...
 * due date.  The tardiness T[j] = max(0, L[j]).
 * So although lateness can be negative, tardiness
 * is never negative. 
 * The weighted number of tardy jobs is equal to the
 * sum of the weights, w[j], of jobs j such that T[j] &gt; 0.
 *
