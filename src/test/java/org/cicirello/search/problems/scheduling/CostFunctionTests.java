...
/** JUnit tests for the various classes that implement scheduling problem cost functions. */
public class CostFunctionTests {
  ...
  private static class TestScheduleDataNoDuedates implements SingleMachineSchedulingProblemData {
    ...
    public int[] getCompletionTimes(Permutation s) {
      return null;
    }
  ...
  private static class TestScheduleData implements SingleMachineSchedulingProblemData {
    ...
    @Override
    public int getReleaseDate(int j) {
      return r != null ? r[j] : 0;
    }
    ...
    @Override
    public boolean hasReleaseDates() {
      return r != null;
    }
