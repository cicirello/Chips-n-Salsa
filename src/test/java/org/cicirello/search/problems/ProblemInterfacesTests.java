...
/** JUnit test cases for the default methods of the various problem related interfaces. */
public class ProblemInterfacesTests {

  @Test
  public void testOptimizationProblem() {
    OptimizationProblem<Permutation> defaults =
        new OptimizationProblem<Permutation>() {
  ...
  public void testIntegerCostOptimizationProblem() {
    IntegerCostOptimizationProblem<Permutation> defaults =
        new IntegerCostOptimizationProblem<Permutation>() {
