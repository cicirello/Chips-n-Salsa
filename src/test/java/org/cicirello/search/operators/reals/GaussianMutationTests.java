...
public class GaussianMutationTests {
	...
	private void verifyMutate1(AbstractRealMutation<RealValued> m) {
		int countLow = 0;
		int countHigh = 0;
	...
	private void verifyMutate1(AbstractRealMutation<RealValued> m, double p) {
		int countLow = 0;
		int countHigh = 0;
	...
	private void verifyMutate1(AbstractRealMutation<RealValued> m, int K) {
		int countLow = 0;
		int countHigh = 0;
		for (int i = 0; i < MAX_TRIALS && (countLow==0 || countHigh==0); i++) {
			SingleReal f = new SingleReal(9.0);
