 ...
 * next generation. The EA implemented by this class does not use crossover.
 *
 ...
 *
 * <p>See the {@link GenerationalEvolutionaryAlgorithm} class for a generational EA with both
...
public class GenerationalMutationOnlyEvolutionaryAlgorithm<T extends Copyable<T>>
  ...
  /**
   * Constructs and initializes the evolutionary algorithm with mutation only. This constructor
   * supports fitness functions with fitnesses of type double, the {@link FitnessFunction.Double}
   * interface.
   *
   ...
   *     null.
   */
  public GenerationalMutationOnlyEvolutionaryAlgorithm(
      int n,
  ...
  /**
   * Constructs and initializes the evolutionary algorithm with mutation only. This constructor
   * supports fitness functions with fitnesses of type int, the {@link FitnessFunction.Integer}
   * interface.
   *
   * @param n The population size.
   * @param mutation The mutation operator.
   ...
   * Constructs and initializes the evolutionary algorithm with mutation only. This constructor
   * supports fitness functions with fitnesses of type double, the {@link FitnessFunction.Double}
   * interface. This constructor also supports specifying the replacement strategy via the {@link
  ...
  public GenerationalMutationOnlyEvolutionaryAlgorithm(
      ...
      int eliteCount) {
    this(
        n, mutation, mutationRate, initializer, f, selection, eliteCount, new ProgressTracker<T>());
  }
  ...
  GenerationalMutationOnlyEvolutionaryAlgorithm(
      GenerationalMutationOnlyEvolutionaryAlgorithm<T> other) {
    super(other);
  }
