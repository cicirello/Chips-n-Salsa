...
/**
 * JUnit 4 test cases for PopulationMember.
 */
public class PopulationMemberTests {
	...
	public void testPopulationMemberDoubleFitness() {
		...
		double fit = 12.5;
		PopulationMember.DoubleFitness<TestObject> pm = new PopulationMember.DoubleFitness<TestObject>(original, fit);
	...
	public void testPopulationMemberIntegerFitness() {
		TestObject original = new TestObject();
		int fit = 12;
		PopulationMember.IntegerFitness<TestObject> pm = new PopulationMember.IntegerFitness<TestObject>(original, fit);
		assertTrue(original == pm.getCandidate());
