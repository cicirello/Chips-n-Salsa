...
/** JUnit test cases for the PolynomialRootFinding. */
public class PolynomialRootFindingTests {
  ...
  public void testConstructorExceptions() {
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new PolynomialRootFinding(new double[1], 0.001));
    thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new PolynomialRootFinding(new double[0], 0.001));
  }
