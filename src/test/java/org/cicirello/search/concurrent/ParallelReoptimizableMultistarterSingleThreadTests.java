...
public class ParallelReoptimizableMultistarterSingleThreadTests {
	...
	public void testConstantLength_Split() {
		...
		TestRestartedMetaheuristic heur = new TestRestartedMetaheuristic();
		ParallelReoptimizableMultistarter<TestObject> restarter1 = new ParallelReoptimizableMultistarter<TestObject>(heur, 1, 1);
		restarter1.close();
		ParallelReoptimizableMultistarter<TestObject> restarter = restarter1.split();
		IllegalStateException thrown = assertThrows( 
			IllegalStateException.class,
	...
	public void testConstantLength_Constructor2() {
		...
		IllegalArgumentException thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> new ParallelReoptimizableMultistarter<TestObject>(heur, new ConstantRestartSchedule(1), 0)
		);
	}
	...
	public void testConstantLength_Constructor5() {
		...
		IllegalArgumentException thrown = assertThrows( 
			...
			() -> {
				ArrayList<ReoptimizableMetaheuristic<TestObject>> heurs = new ArrayList<ReoptimizableMetaheuristic<TestObject>>();
				heurs.add(new TestRestartedMetaheuristic());
				ParallelReoptimizableMultistarter<TestObject> restarter = new ParallelReoptimizableMultistarter<TestObject>(heurs, 0);
			}
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
			() -> {
				...
				heurs.add(new TestRestartedMetaheuristic(problem));
				heurs.add(h);
				ParallelReoptimizableMultistarter<TestObject> restarter = new ParallelReoptimizableMultistarter<TestObject>(heurs, 1);
			}
		);
		thrown = assertThrows( 
			IllegalArgumentException.class,
	...
	public void testConstantLength_Constructor6() {
		...
		IllegalArgumentException thrown = assertThrows( 
			...
			() -> {
				TestRestartedMetaheuristic heur = new TestRestartedMetaheuristic();
				ReoptimizableMultistarter<TestObject> multiStarter = new ReoptimizableMultistarter<TestObject>(heur, 1);
				ParallelReoptimizableMultistarter<TestObject> restarter = new ParallelReoptimizableMultistarter<TestObject>(multiStarter, 0);
			}
		);
	}
	...
	public void testConstantLength_Constructor7() {
		...
		IllegalArgumentException thrown = assertThrows( 
			...
			() -> {
				...
				heurs.add(new ReoptimizableMultistarter<TestObject>(new TestRestartedMetaheuristic(new TestProblem()), 1));
				ParallelReoptimizableMultistarter<TestObject> restarter = new ParallelReoptimizableMultistarter<TestObject>(heurs);
			}
		);
		thrown = assertThrows( 
			...
			() -> {
				...
				heurs.add(new ReoptimizableMultistarter<TestObject>(heur, 1));
				heurs.add(new ReoptimizableMultistarter<TestObject>(new TestRestartedMetaheuristic(p), 1));
				ParallelReoptimizableMultistarter<TestObject> restarter = new ParallelReoptimizableMultistarter<TestObject>(heurs);
			}
		);
	}
