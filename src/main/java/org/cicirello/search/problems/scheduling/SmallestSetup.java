 ...
 *
 * <p>The heuristic values are computed each time the {@link #h} method is called. Therefore, for a
 ...
 * instead using the {@link SmallestSetupPrecompute} class, which implements the same heuristic, but
 * it precomputes a table of heuristic values upon constructing the heuristic object.
 *
