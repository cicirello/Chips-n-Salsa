...
/**
 * This is an implementation of Montagne's heuristic heuristic. This heuristic is defined as: h(j) =
 * (w[j]/p[j])(1 - (d[j]/&Sigma;<sub>i</sub>p[i]), where w[j] is the weight of job j, p[j] is its
 * processing time, and d[j] is job j's due date. The &Sigma;<sub>i</sub>p[i] is the sum of the
 * processing times of the remaining unscheduled jobs.
 *
