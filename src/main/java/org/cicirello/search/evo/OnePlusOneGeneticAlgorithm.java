...
public final class OnePlusOneGeneticAlgorithm extends OnePlusOneEvolutionaryAlgorithm<BitVector> {
  ...
  public OnePlusOneGeneticAlgorithm(
      OptimizationProblem<BitVector> problem, double m, int bitLength) {
   ...
   */
  public OnePlusOneGeneticAlgorithm(
      IntegerCostOptimizationProblem<BitVector> problem, double m, int bitLength) {
    this(problem, m, bitLength, new ProgressTracker<BitVector>());
  }
   ...
   */
  public OnePlusOneGeneticAlgorithm(
      OptimizationProblem<BitVector> problem,
      double m,
      int bitLength,
   ...
   */
  public OnePlusOneGeneticAlgorithm(
      IntegerCostOptimizationProblem<BitVector> problem,
      double m,
      int bitLength,
      ProgressTracker<BitVector> tracker) {
    super(problem, new BitFlipMutation(m), new BitVectorInitializer(bitLength), tracker);
