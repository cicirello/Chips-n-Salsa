 ...
 * uniformly at random and swaps their locations. The pair of indexes for the chosen elements are
 * chosen uniformly at random from among all n(n-1)/2 possible pairs of indexes, where n is the
 * length of the permutation.
 *
 * <p>The runtime of both the {@link #mutate(Permutation) mutate} and {@link #undo(Permutation)
 * undo} methods is O(1) since only a constant number of assignments are necessary to execute a
 * swap.
 *
