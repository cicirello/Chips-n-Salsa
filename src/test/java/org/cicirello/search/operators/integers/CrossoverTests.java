...
public class CrossoverTests {
  ...
  public void testUniformCrossoverBounded() {
    UniformCrossover<BoundedIntegerVector> crossover0 =
        new UniformCrossover<BoundedIntegerVector>(0.0);
    UniformCrossover<BoundedIntegerVector> crossover1 =
        new UniformCrossover<BoundedIntegerVector>(1.0);
    UniformCrossover<BoundedIntegerVector> crossoverDefault =
        new UniformCrossover<BoundedIntegerVector>();
    UniformCrossover<BoundedIntegerVector> crossover05 =
        new UniformCrossover<BoundedIntegerVector>(0.5);
  ...
  public void testSinglePoint() {
    ...
    SinglePointCrossover<BoundedIntegerVector> crossoverBounded =
        new SinglePointCrossover<BoundedIntegerVector>();
  ...
  public void testTwoPoint() {
    ...
    TwoPointCrossover<BoundedIntegerVector> crossoverBounded =
        new TwoPointCrossover<BoundedIntegerVector>();
  ...
  public void testKPoint1() {
    ...
    KPointCrossover<BoundedIntegerVector> crossoverBounded =
        new KPointCrossover<BoundedIntegerVector>(1);
    ...
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, () -> new KPointCrossover<IntegerVector>(0));
  }
  ...
  public void testKPoint2() {
    ...
    KPointCrossover<BoundedIntegerVector> crossoverBounded =
        new KPointCrossover<BoundedIntegerVector>(2);
    validateMultiPointCrossoverBounded(crossoverBounded, 2);
  ...
  public void testKPoint3() {
    ...
    KPointCrossover<BoundedIntegerVector> crossoverBounded =
        new KPointCrossover<BoundedIntegerVector>(3);
  ...
  public void testKPoint4() {
    ...
    KPointCrossover<BoundedIntegerVector> crossoverBounded =
        new KPointCrossover<BoundedIntegerVector>(4);
  ...
  private void validateMultiPointCrossover(
      CrossoverOperator<IntegerVector> crossover, int expectedCrossPoints) {
  ...
  private void validateMultiPointCrossoverBounded(
      CrossoverOperator<BoundedIntegerVector> crossover, int expectedCrossPoints) {
    for (int n = Math.max(2, expectedCrossPoints); n <= 32; n *= 2) {
      int[] a1 = new int[n];
      int[] a2 = new int[n];
      for (int i = 0; i < n; i++) {
  ...
  private void validateSinglePointCrossoverBounded(
      CrossoverOperator<BoundedIntegerVector> crossover) {
    for (int n = 2; n <= 32; n *= 2) {
      int[] a1 = new int[n];
      int[] a2 = new int[n];
      for (int i = 0; i < n; i++) {
