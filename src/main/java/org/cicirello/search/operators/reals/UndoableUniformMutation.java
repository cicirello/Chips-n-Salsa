...
/**
 * This class implements a uniform mutation with support for the {@link #undo} method. Uniform
 ...
 */
public class UndoableUniformMutation<T extends RealValued> extends AbstractUndoableRealMutation<T>
    implements Copyable<UndoableUniformMutation<T>> {
   ...
   */
  UndoableUniformMutation(double radius, DoubleBinaryOperator transformer, Selector selector) {
