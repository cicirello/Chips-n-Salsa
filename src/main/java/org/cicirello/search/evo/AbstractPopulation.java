...
/**
 * An abstract base class for the functionality common to all forms of population
 * within the library to avoid redundancy. 
 *
...
abstract class AbstractPopulation<T extends Copyable<T>> implements Population<T> {
	...
	@Override
	abstract public AbstractPopulation<T> split();
}
