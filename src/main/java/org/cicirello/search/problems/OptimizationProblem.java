...
/**
 * <p>The OptimizationProblem interface provides search algorithms with a way
 ...
 * traveling salesperson, bin packing, etc).</p>
 *
 ...
 * The default implementation returns Double.NEGATIVE_INFINITY and is appropriate for a
...
public interface OptimizationProblem<T extends Copyable<T>> extends Problem<T> {
	 ...
	 * The default implementation returns Double.NEGATIVE_INFINITY.
	 *
	 * @return A lower bound on the minimum theoretical cost of the problem instance. 
	 */
	default double minCost() { return Double.NEGATIVE_INFINITY; }
	 ...
	 */
	default boolean isMinCost(double cost) { return cost == minCost(); }
