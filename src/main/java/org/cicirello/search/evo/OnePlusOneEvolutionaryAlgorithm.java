...
/**
 * <p>This class implements a (1+1)-EA. In a (1+1)-EA, the evolutionary algorithm has a
 ...
 * This class supports optimizing arbitrary structures, specified by the generic type
 * parameter.</p>
 *
 ...
 */
public class OnePlusOneEvolutionaryAlgorithm<T extends Copyable<T>> implements SingleSolutionMetaheuristic<T> {
	...
	/**
	 * Continues optimizing starting from the previous best found solution contained
	 * in the tracker object, rather than from a random one. If no prior
	 * run had been performed, then this method starts the run from a randomly generated
	 * solution.
	 *
	 ...
	 * in this instance's {@link ProgressTracker}, which contains the best of all runs.
	...
	/**
	 * <p>Gets the total number of evaluations (iterations)
	 * performed by this EA object. This is the total number of
