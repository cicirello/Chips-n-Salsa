...
public class OnePlusOneEATests {
    ...
    public void setUp() {
		...
		d_unknown = new OnePlusOneEvolutionaryAlgorithm<TestObject>(pd_unknown, new TestMutation(), new TestInitializer());
		d_known = new OnePlusOneEvolutionaryAlgorithm<TestObject>(pd_known, new TestMutation(), new TestInitializer());
		i_unknown = new OnePlusOneEvolutionaryAlgorithm<TestObject>(pi_unknown, new TestMutation(), new TestInitializer());
		i_known = new OnePlusOneEvolutionaryAlgorithm<TestObject>(pi_known, new TestMutation(), new TestInitializer());
	}
	...
	public void testConstructorExceptions() {
		NullPointerException thrown = assertThrows( 
			...
			() -> new OnePlusOneEvolutionaryAlgorithm<TestObject>((OptimizationProblem<TestObject>)null, new TestMutation(), new TestInitializer(), new ProgressTracker<TestObject>())
		);
		thrown = assertThrows( 
			NullPointerException.class,
			() -> new OnePlusOneEvolutionaryAlgorithm<TestObject>(pd_known, null, new TestInitializer(), new ProgressTracker<TestObject>())
		);
		thrown = assertThrows( 
			NullPointerException.class,
			() -> new OnePlusOneEvolutionaryAlgorithm<TestObject>(pd_known, new TestMutation(), null, new ProgressTracker<TestObject>())
		);
		thrown = assertThrows( 
			NullPointerException.class,
			() -> new OnePlusOneEvolutionaryAlgorithm<TestObject>(pd_known, new TestMutation(), new TestInitializer(), (ProgressTracker<TestObject>)null)
		);
		thrown = assertThrows( 
			NullPointerException.class,
			() -> new OnePlusOneEvolutionaryAlgorithm<TestObject>((IntegerCostOptimizationProblem<TestObject>)null, new TestMutation(), new TestInitializer(), new ProgressTracker<TestObject>())
		);
		thrown = assertThrows( 
			NullPointerException.class,
			() -> new OnePlusOneEvolutionaryAlgorithm<TestObject>(pi_known, null, new TestInitializer(), new ProgressTracker<TestObject>())
		);
		thrown = assertThrows( 
			NullPointerException.class,
			() -> new OnePlusOneEvolutionaryAlgorithm<TestObject>(pi_known, new TestMutation(), null, new ProgressTracker<TestObject>())
		);
		thrown = assertThrows( 
			NullPointerException.class,
			() -> new OnePlusOneEvolutionaryAlgorithm<TestObject>(pi_known, new TestMutation(), new TestInitializer(), (ProgressTracker<TestObject>)null)
		);
	}
	...
	public void testConstructors() {
		...
		OnePlusOneEvolutionaryAlgorithm<TestObject> ea = new OnePlusOneEvolutionaryAlgorithm<TestObject>(pi_known, mutation, init, tracker);
		ea.optimize(1);
	...
	public void testStopFromAnotherThread() {
		...
		ProgressTracker<TestObject> tracker = new ProgressTracker<TestObject>();
		OnePlusOneEvolutionaryAlgorithm<TestObject> ea = new OnePlusOneEvolutionaryAlgorithm<TestObject>(pi_unknown, mutation, init, tracker);
