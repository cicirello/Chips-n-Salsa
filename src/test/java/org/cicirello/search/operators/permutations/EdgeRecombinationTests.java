...
public class EdgeRecombinationTests {
	...
	public void testEnhancedEdgeMapAnyRemaining() {
		...
		int[] raw2 = {2, 7, 3, 6, 0, 5, 1, 4};
		boolean[] used = new boolean[raw1.length];
		EnhancedEdgeRecombination.EnhancedEdgeMap map = new EnhancedEdgeRecombination.EnhancedEdgeMap(raw1, raw2);
		for (int i = 0; i < raw1.length; i++) {
			int element = map.anyRemaining();
			assertFalse(used[element]);
			map.used(element);
	...
	public void testEnhancedEdgeMapPick() {
		...
		int[] raw2 = {2, 7, 3, 6, 0, 5, 1, 4};
		boolean[] used = new boolean[raw1.length];
		EnhancedEdgeRecombination.EnhancedEdgeMap map2 = new EnhancedEdgeRecombination.EnhancedEdgeMap(raw1, raw2);
		EnhancedEdgeRecombination.EnhancedEdgeMap map1 = new EnhancedEdgeRecombination.EnhancedEdgeMap(map2);
		map1.used(0);
		int element = map1.pick(0);
		assertTrue(element == 7 || element == 1 || element == 5 || element == 6);
		map1.used(5);
	...
	public void testEnhancedEdgeMapPickAllCommon() {
		...
		int[] raw2 = {0, 1, 2, 3, 4, 5, 6, 7};
		boolean[] used = new boolean[raw1.length];
		EnhancedEdgeRecombination.EnhancedEdgeMap map1 = new EnhancedEdgeRecombination.EnhancedEdgeMap(raw1, raw2);
		EnhancedEdgeRecombination.EnhancedEdgeMap map2 = new EnhancedEdgeRecombination.EnhancedEdgeMap(map1);
		map1.used(7);
		int element = map1.pick(7);
		assertTrue(element == 0 || element == 6);
		map1.used(0);
	...
	public void testEnhancedEdgeMapPickCommonSequence() {
		...
		boolean[] used = new boolean[raw1.length];
		EnhancedEdgeRecombination.EnhancedEdgeMap map1 = new EnhancedEdgeRecombination.EnhancedEdgeMap(raw1, raw2);
		EnhancedEdgeRecombination.EnhancedEdgeMap map2 = new EnhancedEdgeRecombination.EnhancedEdgeMap(raw1, raw3);
		// raw1 vs raw 2
		map1.used(7);
		int element = map1.pick(7);
		assertEquals(6, element);
