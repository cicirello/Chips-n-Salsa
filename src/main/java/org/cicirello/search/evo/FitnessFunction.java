 ...
 * {@link SelectionOperator} classes of this library assume that fitness values are positive, so for
...
public interface FitnessFunction<T extends Copyable<T>> {
  ...
  /**
   * Fitness function interface for double-valued fitnesses. Implement this interface to provide a
   * fitness function for use by genetic algorithms and other forms of evolutionary computation.
   * Some of the {@link SelectionOperator} classes of this library assume that fitness values are
  ...
  interface Double<T extends Copyable<T>> extends FitnessFunction<T> {
    ...
    /**
     * Computes the fitness of a candidate solution to a problem, for use by genetic algorithms and
