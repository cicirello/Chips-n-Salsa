...
/**
 * JUnit test cases for the classes that implement different variations of Cauchy mutation for
...
public class CauchyMutationTests extends SharedTestRealMutationOps {
  ...
  public void testExceptions() {
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class, () -> CauchyMutation.createCauchyMutation(1.0, 0));
    thrown =
        assertThrows(
            IllegalArgumentException.class, () -> CauchyMutation.createCauchyMutation(1.0, 0.0));
    thrown =
        assertThrows(
  ...
  public void testConstrainedCauchyMutation() {
    {
      ...
      assertTrue(r.get(1) >= 2.0 && r.get(1) <= 5.0);
      assertTrue(r.get(2) >= 2.0 && r.get(2) <= 5.0);
      assertTrue(r.get(3) >= 2.0 && r.get(3) <= 5.0);
      assertTrue(r.get(4) >= 2.0 && r.get(4) <= 5.0);
      assertTrue(r.get(5) >= 2.0 && r.get(5) <= 5.0);
      assertTrue(r.get(6) >= 2.0 && r.get(6) <= 5.0);
  ...
  public void testUndoableConstrainedCauchyMutation() {
    UndoableCauchyMutation<RealValued> g1 =
        UndoableCauchyMutation.createCauchyMutation(1.0, -10.0, 10.0);
    assertEquals(1.0, g1.get(0));
    verifyMutate1(g1);
    verifyUndo(g1);

    UndoableCauchyMutation<RealValued> g5 =
        UndoableCauchyMutation.createCauchyMutation(5.0, -10.0, 10.0);
    assertEquals(5.0, g5.get(0));
    verifyMutate1(g5);
    verifyUndo(g5);

    UndoableCauchyMutation<RealValued> g =
        UndoableCauchyMutation.createCauchyMutation(0.1, 2.0, 5.0);
