...
public class TSPTests {
  ...
  public void testIntCostFromArrays() {
    ...
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new TSP.Integer(new double[2], new double[3]));
    thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new TSP.Integer(new double[1], new double[1]));
  }
  ...
  public void testIntCostFromArraysWithDistance() {
    ...
    TSP.Integer tsp =
        new TSP.Integer(x, y, (x1, y1, x2, y2) -> Math.abs(x1 - x2) + Math.abs(y1 - y2));
    assertEquals(0, tsp.minCost());
    assertEquals(x.length, tsp.x.length);
    assertEquals(y.length, tsp.y.length);
    assertTrue(x != tsp.x);
  ...
  public void testIntCostWithDistance() {
    ...
    int N = 10;
    TSP.Integer tsp =
        new TSP.Integer(N, W, (x1, y1, x2, y2) -> Math.abs(x1 - x2) + Math.abs(y1 - y2));
    assertEquals(0, tsp.minCost());
    assertEquals(N, tsp.x.length);
    assertEquals(N, tsp.y.length);
    for (int i = 0; i < N; i++) {
    ...
    W = 10;
    N = 3;
    tsp = new TSP.Integer(N, W, (x1, y1, x2, y2) -> Math.abs(x1 - x2) + Math.abs(y1 - y2));
    assertEquals(N, tsp.x.length);
    assertEquals(N, tsp.y.length);
    int[] permArray = {1, 2, 0};
    Permutation perm = new Permutation(permArray);
  ...
  public void testIntCostSeedWithDistance() {
    ...
    int N = 10;
    TSP.Integer tsp =
        new TSP.Integer(N, W, (x1, y1, x2, y2) -> Math.abs(x1 - x2) + Math.abs(y1 - y2), 42);
    assertEquals(0, tsp.minCost());
    assertEquals(N, tsp.x.length);
    assertEquals(N, tsp.y.length);
    for (int i = 0; i < N; i++) {
    ...
    W = 10;
    N = 3;
    tsp = new TSP.Integer(N, W, (x1, y1, x2, y2) -> Math.abs(x1 - x2) + Math.abs(y1 - y2), 42);
    assertEquals(N, tsp.x.length);
    assertEquals(N, tsp.y.length);
    int[] permArray = {1, 2, 0};
    Permutation perm = new Permutation(permArray);
  ...
  public void testDoubleCostMatrixFromArraysWithDistance() {
    ...
    TSP.DoubleMatrix tsp =
        new TSP.DoubleMatrix(x, y, (x1, y1, x2, y2) -> Math.abs(x1 - x2) + Math.abs(y1 - y2));
    assertEquals(0, tsp.minCost(), 0.0);
    assertEquals(x.length, tsp.x.length);
    assertEquals(y.length, tsp.y.length);
    assertTrue(x != tsp.x);
  ...
  public void testDoubleCostMatrixWithDistance() {
    ...
    int N = 10;
    TSP.DoubleMatrix tsp =
        new TSP.DoubleMatrix(N, W, (x1, y1, x2, y2) -> Math.abs(x1 - x2) + Math.abs(y1 - y2));
    assertEquals(0, tsp.minCost(), 0.0);
    assertEquals(N, tsp.x.length);
    assertEquals(N, tsp.y.length);
    for (int i = 0; i < N; i++) {
    ...
    W = 10;
    N = 3;
    tsp = new TSP.DoubleMatrix(N, W, (x1, y1, x2, y2) -> Math.abs(x1 - x2) + Math.abs(y1 - y2));
    assertEquals(N, tsp.x.length);
    assertEquals(N, tsp.y.length);
    int[] permArray = {1, 2, 0};
    Permutation perm = new Permutation(permArray);
  ...
  public void testDoubleCostMatrixSeedWithDistance() {
    ...
    int N = 10;
    TSP.DoubleMatrix tsp =
        new TSP.DoubleMatrix(N, W, (x1, y1, x2, y2) -> Math.abs(x1 - x2) + Math.abs(y1 - y2), 42);
    assertEquals(0, tsp.minCost(), 0.0);
    assertEquals(N, tsp.x.length);
    assertEquals(N, tsp.y.length);
    for (int i = 0; i < N; i++) {
    ...
    W = 10;
    N = 3;
    tsp = new TSP.DoubleMatrix(N, W, (x1, y1, x2, y2) -> Math.abs(x1 - x2) + Math.abs(y1 - y2), 42);
    assertEquals(N, tsp.x.length);
    assertEquals(N, tsp.y.length);
    int[] permArray = {1, 2, 0};
    Permutation perm = new Permutation(permArray);
