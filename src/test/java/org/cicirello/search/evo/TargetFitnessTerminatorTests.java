...
/** JUnit test cases for TargetFitnessTerminator interface. */
public class TargetFitnessTerminatorTests {

  @Test
  public void test() {
    TargetFitnessTerminator<String> terminator = new TargetFitnessTerminator<String>(5);
