...
public class CostScalerTests {
  ...
  public void testCostScaler() {
    ...
    IllegalArgumentException thrown =
        assertThrows(
            IllegalArgumentException.class, () -> new CostFunctionScaler<TestObject>(problem, 0));
  }

  @Test
  public void testIntegerCostScaler() {
    TestProblemInt problem = new TestProblemInt();
    IntegerCostFunctionScaler<TestObject> cfs =
        new IntegerCostFunctionScaler<TestObject>(problem, 10);
    for (int i = 5; i <= 7; i++) {
