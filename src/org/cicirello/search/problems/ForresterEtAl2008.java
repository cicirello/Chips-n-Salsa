 ...
 * for inputs x in [0.0, 1.0].</p>
 *
 * <p>This minimization problem was introduced in:</p>
 * <ul>
 * <li>Forrester, A.I.J.; Sóbester, A.; Keane, A.J. Appendix: Example Problems. 
 * In Engineering Design via Surrogate Modelling: A Practical Guide; John Wiley and 
 * Sons, Ltd, 2008; pp. 195–203. doi:10.1002/9780470770801.app1.</li>
 * </ul>
 *
 * <p>The lower fidelity variation is as defined 
 * <a href="https://www.sfu.ca/~ssurjano/forretal08.html">https://www.sfu.ca/~ssurjano/forretal08.html</a>.</p>
 *
...
public final class ForresterEtAl2008 implements OptimizationProblem<SingleReal>, Initializer<SingleReal> {
	 ...
	 * @param lowerFidelity - If false, constructs the original function. If true,
	 * constructs the lower fidelity version of the function.
	 */
